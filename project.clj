(defproject u1stgames "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "u1stgames.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main u1stgames.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "u1stgames.core/on-figwheel-reload"}

                :compiler {:main u1stgames.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/u1stgames.js"
